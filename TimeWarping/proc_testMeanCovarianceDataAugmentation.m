...
original_tr.x = downsample(original_tr.x, 10);
augmented_tr.x = downsample(augmented_tr.x, 10);
original_te.x = downsample(original_te.x, 10);

%% This is done to downsample the epochs from 1000Hz to 100Hz
...
original_tr.t = -190:10:1200;
augmented_tr.t = -190:10:1200;
original_te.t = -190:10:1200;
